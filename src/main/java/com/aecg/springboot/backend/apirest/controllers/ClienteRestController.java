...
import com.aecg.springboot.backend.apirest.models.services.IClienteService;
import com.aecg.springboot.backend.apirest.models.services.IUploadFileService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		log.debug("Eliminamos cliente "+id);
		Map<String, Object> response = new HashMap<>();
		try {
			Cliente cliente = clienteService.findById(id);
			//Eliminamos la foto anterior en el caso de que existiera.
	...
	@GetMapping("/uploads/img/{nombreFoto:.+}") //el :.+ indica que tiene que ser un nombre con su extensión.
	public ResponseEntity<Resource> verFoto(@PathVariable String nombreFoto) {
		...
		//Esta cabecera es necesaria para forzar la descarga del archivo.
